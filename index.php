...
<body class="bg-light">
	...
	<div class="container">
		<div class="py-5 text-center">
			...
			<p class="lead">Para el Parlamento de Personas con Discapacidad
			</p>
			<p>
					...
					<div class="row">
						<div class="col-6">
							...
							<div class="form-group">
								...
								<input required type="number" name="total" class="form-control" id="total" aria-describedby="total" value="<?php (isset($_POST['total'])) ? print $_POST['total'] : print '0' ?>">
						...
						<div class="col-6">
							<div class="form-group">
								...
								<input required type="number" name="titulares" class="form-control" id="titulares" value="<?php (isset($_POST['titulares'])) ? print $_POST['titulares'] : print '14' ?>">

							</div>
							<div class="form-group">
								<label for="suplentes">Suplentes</label>
								<input required type="number" name="suplentes" class="form-control" id="suplentes" value="<?php (isset($_POST['suplentes'])) ? print $_POST['suplentes'] : print '14' ?>">
		...
		?>
			...
			if (($titulares + $suplentes) <= $total) {
				...
				foreach ($rand_keys as $key => $rand_key) {
					...
					if ($sheetData[$rand_key][3] == 'M' and $masc < $masculino) {
						print('<li class="list-group-item d-flex justify-content-between lh-condensed">');
						...
						$i++;
						$masc++;
					} elseif ($sheetData[$rand_key][3] == 'F' and $fem < $femenino) {
						print('<li class="list-group-item d-flex justify-content-between lh-condensed">');
						print('<div><h3 class="my-0">#' . $i . '</h3></div>');
						if ($sheetData) {
				...
				print('<div class="col-md-6 mb-6">');
				print('<h4 class="d-flex justify-content-between align-items-center mb-3">');
				print('<span class="text-muted">Pro Secretario Legislativo</span>');
				print('</h4>');
				print('<ul class="list-group mb-3">');
				print('
				<li class="list-group-item d-flex justify-content-between">
				...
				print('<div class="col-md-6 mb-6">');
				print('<h4 class="d-flex justify-content-between align-items-center mb-3">');
				print('<span class="text-muted">Pro Secretario Administrativo</span>');
				print('</h4>');
				print('<ul class="list-group mb-3">');
				print('
				<li class="list-group-item d-flex justify-content-between">
